defmodule PentoWeb.FaqLive.FormComponent do
  ...
  def update(%{faq: faq} = assigns, socket) do
    changeset = Comments.change_faq(faq)
  ...
  def handle_event("validate", %{"faq" => faq_params}, socket) do
    changeset =
      socket.assigns.faq
      |> Comments.change_faq(faq_params)
  ...
  defp save_faq(socket, :edit, faq_params) do
    case Comments.update_faq(socket.assigns.faq, faq_params) do
      {:ok, _faq} ->
        {:noreply,
         socket
  ...
  defp save_faq(socket, :new, faq_params) do
    case Comments.create_faq(faq_params) do
      {:ok, _faq} ->
        {:noreply,
         socket
